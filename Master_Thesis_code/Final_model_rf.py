...
rf = rf.fit(X_train, np.ravel(y_train)) # fit the data to the algorithm

               
#filename = 'final_model_rf.sav'   # filename for model
#joblib.dump(rf, filename)  #save model as file
