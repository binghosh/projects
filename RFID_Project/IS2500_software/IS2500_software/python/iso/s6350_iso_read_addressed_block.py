...
# 9: The ISO command.  In this case 0x20
#

read_addressed_block.extend([0x11, 0x63, 0x20])
...
read_addressed_block.extend([0, 0, 0, 0, 0, 0, 0, 0, 0])
...
# Get the requested block from the user and fill it in
...
#
    ...
    print("Block Data: " + "0x%0.2x" % response[12] + "%0.2x" % response[11]
        + "%0.2x" % response[10] + "%0.2x" % response[9])

    print("Block Security Bits: " +  "0x%0.2x" % response[8])
    print
